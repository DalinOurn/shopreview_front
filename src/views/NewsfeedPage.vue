...
export default {
  ...
  methods: {
    async getPosts() {
      const res = await fetch('http://54.248.141.55:3001/post/all', {
        method: 'GET',
        credentials: 'include',
        headers: {
    ...
    async post(e) {
      ...
      //http://54.248.141.55:3001/post/create
      const post_create = await fetch('http://54.248.141.55:3001/post/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
  ...
  async created() {
    const res = await fetch('http://54.248.141.55:3001/auth/me', {
      method: 'GET',
      credentials: 'include',
      headers: {
        'Content-type': 'application/json',
