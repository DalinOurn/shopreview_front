...
export default {
  ...
  methods: {
    async getPosts() {
      const res = await fetch('http://13.231.249.234:3001/post/all', {
        method: 'GET',
        credentials: 'include',
        headers: {
    ...
    async post(e) {
      ...
      //http://13.231.249.234:3001/post/create
      const post_create = await fetch('http://13.231.249.234:3001/post/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
