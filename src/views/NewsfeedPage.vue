...
export default {
  ...
  methods: {
    async getPosts() {
      const res = await fetch('http://35.78.126.233:3001/post/all', {
        method: 'GET',
        credentials: 'include',
        headers: {
    ...
    async post(e) {
      ...
      //http://35.78.126.233:3001/post/create
      const post_create = await fetch('http://35.78.126.233:3001/post/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
