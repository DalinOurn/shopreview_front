...
export default {
  ...
  methods: {
    async getPosts() {
      const res = await fetch('http://43.206.151.253:3001/post/all', {
        method: 'GET',
        credentials: 'include',
        headers: {
    ...
    async post(e) {
      ...
      //get user
      const user = await fetch('http://43.206.151.253:3001/auth/me', {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
      ...
      //http://43.206.151.253:3001/post/create
      const post_create = await fetch('http://43.206.151.253:3001/post/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
  ...
  async created() {
    const res = await fetch('http://43.206.151.253:3001/auth/me', {
      method: 'GET',
      credentials: 'include',
      headers: {
        'Content-type': 'application/json',
