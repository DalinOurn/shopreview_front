...
export default {
  ...
  methods: {
    async getPosts() {
      const res = await fetch('http://54.168.147.143:3001/post/all', {
        method: 'GET',
        credentials: 'include',
        headers: {
    ...
    async post(e) {
      ...
      //http://54.168.147.143:3001/post/create
      const post_create = await fetch('http://54.168.147.143:3001/post/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
