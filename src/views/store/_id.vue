...
export default {
  ...
  methods: {
    ...
    async subReview() {
      ...
      const res = await fetch(`http://43.206.128.251:3001/review/create`, {
        method: "POST",
        credentials: "include",
        headers: {
    ...
    async getReview() {
      const res = await fetch(
        `http://43.206.128.251:3001/review/all?storeId=${this.id}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
    ...
    async favorite(store_id) {
      ...
      //add to favorite
       const addFav = await fetch('http://43.206.128.251:3001/favorite/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          "Content-type": "application/json",
  ...
  async created() {
    ...
    const res = await fetch(`http://43.206.128.251:3001/store/id/${id}`, {
      method: "GET",
      credentials: "include",
      headers: {
        "Content-type": "application/json",
