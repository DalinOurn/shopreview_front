  ...
  methods: {
    async getStore() {
      const res = await fetch(
        "http://13.230.174.62:3001/store/all?item_per_page=1000",
        {
          method: "GET",
          credentials: "include",
          headers: {
    ...
    async storeActions() {
      let url = "";
      if (this.action == "create") url = "http://13.230.174.62:3001/store/create";
      else url = "http://13.230.174.62:3001/store/update";
    ...
    async deleteItem(store) {
      ...
      const res = await fetch("http://13.230.174.62:3001/store/delete", {
        method: "DELETE",
        credentials: "include",
        headers: {
          "Content-type": "application/json",
    ...
    async handlerImage(e) {
      ...
      const upload_image = await fetch("http://13.230.174.62:3001/upload/image", {
        method: "POST",
        credentials: "include",
        body: formData,
      });
    ...
    async getCategories() {
      const res = await fetch("http://13.230.174.62:3001/category/all", {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-type": "application/json",
