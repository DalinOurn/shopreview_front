  ...
  methods: {
    async getStore() {
      const res = await fetch(
        "http://13.115.253.173:3001/store/all?item_per_page=1000",
        {
          method: "GET",
          credentials: "include",
          headers: {
    ...
    async storeActions() {
      let url = "";
      if (this.action == "create") url = "http://13.115.253.173:3001/store/create";
      else url = "http://13.115.253.173:3001/store/update";
    ...
    async deleteItem(store) {
      ...
      const res = await fetch("http://13.115.253.173:3001/store/delete", {
        method: "DELETE",
        credentials: "include",
        headers: {
          "Content-type": "application/json",
    ...
    async handlerImage(e) {
      ...
      const upload_image = await fetch("http://13.115.253.173:3001/upload/image", {
        method: "POST",
        credentials: "include",
        body: formData,
      });
